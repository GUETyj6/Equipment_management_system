...
urlpatterns = [
    ...
    path('add_scrap/<int:user_pk>',views.add_scrap,name='add_scrap'),
    path('facility_download/',views.facility_download,name='facility_download'),
    path('maintain_download/',views.maintain_download,name='maintain_download'),
    path('repaired_download/',views.repaired_download,name='repaired_download'),
    path('scarp_download/',views.scarp_download,name='scarp_download'),
]
