...
class Scrap(models.Model):#报废
    facility_id = models.ForeignKey(Facility,on_delete=models.CASCADE,verbose_name="报废设备")
    baofei_staff_name = models.ForeignKey(User,on_delete=models.DO_NOTHING,verbose_name="上报人员")
    scarp_time = models.DateField(auto_now=True,verbose_name="报废时间")
    baofei_complementary = models.CharField(max_length=200,verbose_name="报废描述",null=True,blank=True)